...
class SiblingText extends StatelessWidget {
  const SiblingText({super.key});

  @override
  Widget build(BuildContext context) {
    print('SiblingText rebuild');
    return Text('${context.select<Counter, int>((counter) => counter._counter2)}', style: const TextStyle(fontSize: 24.0),);
  }
}